...
ALTER TABLE "mst"."flow_paths" DROP CONSTRAINT IF EXISTS "flow_paths_from_sub_block_id_sub_blocks_id_fk";
--> statement-breakpoint
ALTER TABLE "mst"."flow_paths" DROP CONSTRAINT IF EXISTS "flow_paths_to_sub_block_id_sub_blocks_id_fk";
...
ALTER TABLE "mst"."sensor_calibrations" ADD COLUMN IF NOT EXISTS "sensor_max_distance_mm" integer DEFAULT 1400 NOT NULL;
ALTER TABLE "trx"."irrigation_recommendations" ADD COLUMN IF NOT EXISTS "route_path_ids" jsonb;--> statement-breakpoint
ALTER TABLE "trx"."irrigation_recommendations" ADD COLUMN IF NOT EXISTS "routing_score" numeric(10, 4);--> statement-breakpoint
ALTER TABLE "trx"."sub_block_current_states" ADD COLUMN IF NOT EXISTS "estimated_from_sub_block_ids" uuid[];--> statement-breakpoint
ALTER TABLE "trx"."sub_block_states" ADD COLUMN IF NOT EXISTS "estimated_from_sub_block_ids" uuid[];--> statement-breakpoint
DO $$ BEGIN
